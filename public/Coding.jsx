...
Command: npx gltfjsx@6.2.16 coding.gltf 
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/coding.gltf')

  
  const modelRef = useRef();
  const [rotationAxis, setRotationAxis] = useState([Math.random(), Math.random(), Math.random()]);
